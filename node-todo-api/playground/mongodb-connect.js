...
MongoClient.connect('mongodb://localhost:27017/TodoApp', (err, db) => {
  ...
  db.collection('Todos').insertOne({
    ...
    if (err) {
      ...
      console.log(JSON.stringify(result.ops, undefined, 2)); // .ops is going to store all of the docs that were inserted, ie insertOne so it's just going to be our one document
    }
