...
describe('PATCH /todos/:id', () => {
  it('should update the todo', (done) => {
    ...
    request(app)
      ...
      .send({
        completed: true,
        text // text: text is ES5 sytanx
      })
      .expect(200)
      .expect((res) => { // custom expect call to test the body that comes back matches the body at line 159
  ...
  // we didnt add verification of IDs, you can add them but here, we've done it so many times
});
