...
app.get('/about', (req, res) => {
  res.render('about.hbs', { // render lets you render any of the templates you have set up with your current view engine. The default directory is 'views' for express, our about.hbs in that folder is the template
    ...
    currentYear: new Date().getFullYear() // The 2nd argument of render is an object. We pass the keys (pageTitle, currentYear) to the about.hbs to create a dynamic page with dynamic data. To use these, in our about.hbs we need to use handlebars syntax {{}}
  });
});
